...
---@return Stream<T>: a stream that wraps the provided array
...
-- from "this" stream
---@return Stream<T>: a new stream that contains the elements of "this" stream, filtered
...
---@return Stream<M>: a new stream that contains the elements of "this" stream transformed
